        ...
        fetch(urlApiUsers, {
          ...
          .then((data) => {
            ...
            console.log("token: " + token);
              // Hacer algo con el token, como guardarlo en el almacenamiento local o en las cookies
              // para recuperarlo: localStorage.getItem("token")
      
              // Resto de la lógica después de recibir el token
            } else {
